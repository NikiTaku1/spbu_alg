...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    root.title("Hospital database generator")

    output_frame = tk.Frame(root)
    output_frame.pack(side=tk.TOP, padx=10)

    output_label = tk.Label(output_frame, text="Filename")
    ...
    n_label = tk.Label(column1_frame, text="Banks")
    n_label.grid(row=0, column=0, padx=5, pady=5, sticky=tk.E)

    a_label = tk.Label(column1_frame, text="Sberbank%")
    a_label.grid(row=1, column=0, padx=5, pady=5, sticky=tk.E)
    a_entry = tk.Entry(column1_frame)
    a_entry.grid(row=1, column=1, padx=5, pady=5)

    b_label = tk.Label(column1_frame, text="T-Bank%")
    b_label.grid(row=2, column=0, padx=5, pady=5, sticky=tk.E)
    ...
    d_label.grid(row=4, column=0, padx=5, pady=5, sticky=tk.E)
    ...
    m_label = tk.Label(column2_frame, text="Banking systems")
    m_label.grid(row=0, column=0, padx=5, pady=5, sticky=tk.E)
    ...
    y_label.grid(row=2, column=0, padx=5, pady=5, sticky=tk.E)
    y_entry = tk.Entry(column2_frame)
    y_entry.grid(row=2, column=1, padx=5, pady=5)

    z_label = tk.Label(column2_frame, text="Mir%")
    z_label.grid(row=3, column=0, padx=5, pady=5, sticky=tk.E)
    z_entry = tk.Entry(column2_frame)
    z_entry.grid(row=3, column=1, padx=5, pady=5)

    e_label = tk.Label(column2_frame, text=" ")
    e_label.grid(row=4, column=0, padx=5, pady=5, sticky=tk.E)
